...
class Main extends React.Component {
  render() {
    return (
      ...
      <Jumbotron>
        ...
        <p>
          <Button variant="primary" href ="http://www.realityministriesinc.org">Learn more</Button>
        </p>
      </Jumbotron>
      <CardDeck>
  ...
  <Card.Body>
    ...
    <Card.Text>
      TODO: INSERT GOOGLE MAP WITH LOCATION
    </Card.Text>
...
<Card.Body>
  ...
  <Card.Text>
    SPECIAL EVENTS happen throughout
    the year at Reality Ministries. Highlights include the
     Talent Show and the Kings & Queens Winter Ball. See our current
     calendar for specific events, dates, and times.
  </Card.Text>
